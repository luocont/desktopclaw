...
import desktopclaw.channels.dingtalk as dingtalk_module
from desktopclaw.channels.dingtalk import DingTalkChannel, NanobotDingTalkHandler
from desktopclaw.config.schema import DingTalkConfig
